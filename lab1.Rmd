...
```{r}
1 / 3 * prod(1: 20)
# Above line test runs the same as below
...
```{r}
x_3_bin <- c("none"= 0, "infraction"= 1, "misdemeanor"= 1, "felony"= 1)
names(x_3_bin)
```
...
```{r}
x_3_ord = factor(x_3, levels = levels, ordered = TRUE)
```